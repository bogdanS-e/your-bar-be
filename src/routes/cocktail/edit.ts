...
const handler = async (req: Request, res: Response<IEditCocktailRes | IResError>) => {
...
const editCocktailRoute = (cocktailRouter: Router) => {
  cocktailRouter.put('/edit/:cocktailId', multerUpload.single('image'), validateCocktail, handler);
};
